...
void f2_bx325() {
	TCanvas *c1 = new TCanvas("c1", "Plot of F2 functions for 3.25 versus Bjorken x with error bars", 200, 10, 700, 500);
	c1->SetGrid();
	c1->GetFrame()->SetBorderSize(12);
	
	ifstream NaData;
	NaData.open("F2_325.dat", ios::in);
	...
	{		
        ...
        gr->SetTitle("F2 functions for 3.25 versus Bjorken x");
